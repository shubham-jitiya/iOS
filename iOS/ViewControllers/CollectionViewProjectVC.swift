...
class CollectionViewProjectVC: UIViewController {
    
    // MARK: IB outlets
    @IBOutlet private weak var tvHomeScreen: UITableView!
...
// MARK: IB actions
extension CollectionViewProjectVC {
...
extension CollectionViewProjectVC: UITableViewDataSource {
...
extension CollectionViewProjectVC: UITableViewDelegate {
...
extension CollectionViewProjectVC: SelectedItemDelegate {
