...
class LabelsVC: UIViewController {
    ...
    @IBOutlet private weak var txtField: CustomTextField!
    @IBOutlet private weak var btnOne: UIButton!
    @IBOutlet private weak var lblCustomAttributedText: UILabel!
    @IBOutlet private weak var lblAttributedExtension: UILabel!
