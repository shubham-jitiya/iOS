...
class ButtonVC: UIViewController {
    ...
    //MARK: - IB Outlets
    @IBOutlet private weak var btnTouchUpInside: UIButton!
    @IBOutlet private weak var btnTouchUpOutside: UIButton!
    @IBOutlet private weak var btnTouchDragOutside: UIButton!
    @IBOutlet private weak var btnTouchDragInside: UIButton!
    @IBOutlet private weak var btnTouchDragExit: UIButton!
    @IBOutlet private weak var btnTouchDragEnter: UIButton!
    @IBOutlet private weak var btnTouchDownRepeat: UIButton!
    @IBOutlet private weak var btnBgImage: UIButton!
    @IBOutlet private weak var btnStates: UIButton!
